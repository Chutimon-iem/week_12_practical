...
names(summary_reg_richness)

# see the R2 statistic increase when includes more variable
...
# plot red dot to indicate the model with the largest adjusted R2 statistic
